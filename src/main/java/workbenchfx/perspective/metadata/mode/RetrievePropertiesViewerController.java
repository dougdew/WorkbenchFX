...
import workbenchfx.perspective.metadata.mode.CRUDPropertiesViewerController.MetadataProperty;
...
public class RetrievePropertiesViewerController {
	...
	public RetrievePropertiesViewerController(RetrieveMode mode) {
		this.mode = mode;
		createGraph();
	}
